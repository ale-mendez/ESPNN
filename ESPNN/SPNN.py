...
class Model(nn.Module):#hidden_size2 = 20
    def __init__(self, num_features, num_targets, hidden_size1 = 10, hidden_size2=20,drop_rate1=0.2,drop_rate2=0.5,drop_rate3=0.5): 
                                                                        #30
        ...
        self.dense3 = nn.utils.weight_norm(nn.Linear(hidden_size2, 64))  #32
        
      
        self.dropout4 = nn.Dropout(drop_rate3)
        self.dense4 = nn.utils.weight_norm(nn.Linear(64, hidden_size2))
