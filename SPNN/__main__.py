...
if __name__ == "__main__":
    ...
    parser.add_argument("-emin", dest="emin", default=0.001, type=float, help="Minimum energy value (default: 0.001)")
    parser.add_argument("-emax", dest="emax", default=10., type=float, help="Maximum energy value (default: 10)")
    parser.add_argument("-npoints", dest="npoints", default=1000, type=int, help="Number of grid points (default: 1000)")
    parser.add_argument("--plot", dest='plot', default=True, help="Plot prediction (default: True)")
    parser.add_argument("--outdir", dest='outdir', default='./', help="Path to output folder (default: './')")
